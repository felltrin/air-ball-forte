import { Button, Container, Flex, Stack, Text, Theme } from "@chakra-ui/react";
          ...
          <Stack alignItems={"center"} justifyContent={"center"} gap={10}>
            <Flex maxW={"750px"} textStyle={"4xl"}>
              <Text textAlign={"center"}>
                ...
                workouts. This is transforming the mundane into a fun activity
                to be experienced. Come join us!{" "}
              </Text>
            </Flex>
